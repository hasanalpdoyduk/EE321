...
def print_usage(option=1):
    ...
    print('assembler_iss_mem_init_gen.py example.asm r')
    print_blank_line(1)
    print("Simulate All Mode:")
    print('assembler_iss_mem_init_gen.py example.asm q')
    print_blank_line(2)
...
7 : "LTi", 8 : "CP", 9 : "CPi", 10 : "CPI", 11 : "CPIi", 12 : "BZJ", 13 : "BZJi", 14 : "MUL", 15 : "MULi"}
        ...
        if self.architecture == 1:
            if (opcode >= 0 and opcode <= 11) or (opcode >= 14 and opcode <= 15):
                ...
                if opcode == self.opcodes_v1["ADD"]:
                    ...
                    self.mem_array_init[temp_1] = "used"
                
                self.program_counter = self.program_counter + 1

                self.mem_array_init[operand_1] = "used" 
    ...
    def run_simulation(self):
        ...
        while(sim_finished == False):
            ...
            #if (instruction_or_data & 0xFFFFFFFF) > 0: # CAUTION: it is assumed that instructions such as 'ADD 0 0' or 'NAND 0 0' are not generated by compiler
            if(True): # CAUTION: it is assumed that instructions such as 'ADD 0 0' or 'NAND 0 0' are not generated by compiler
